...
interface MoviesApiHelper {
    ...
    fun getMovies(@Query("sort_by") sortType: String,
                  ...
                  @Query("api_key") apiKey: String = API_KEY): Observable<MoviesResponse>

    @GET("3/movie/{id}")
    fun getDurationForMovie(@Path("id") id: Int, @Query("api_key") apiKey: String = API_KEY): Observable<MovieDetail>
